...
namespace FrbaHotel
{
    class Comandos
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT DISTINCT fn.nombreFunc FROM DEVOLVESELA_A_MESSI.rol r, DEVOLVESELA_A_MESSI.rolFuncionalidad rf, DEVOLVESELA_A_MESSI.funcionalidadNombre fn WHERE rf.codFunc = fn.codFunc AND r.rol=rf.rol AND r.rol='" + rol + "'", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
            con.Close();
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM DEVOLVESELA_A_MESSI.funcionalidadNombre", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
            con.Close();
        ...
        public void llenarDataGridView(DataGridView dgv, string consulta)
        {
            con.Open();
